...
export class UpdateWorkScheduleDto {
  @ApiProperty({ description: '员工ID', example: 'user-uuid-001', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  userId?: string;
  ...
  @ApiProperty({ description: '开始时间 ISO datetime', example: '2025-03-10T08:00:00', required: false })
  @IsOptional()
  @IsDateString()
  startAt?: string;

  @ApiProperty({ description: '结束时间 ISO datetime', example: '2025-03-10T12:00:00', required: false })
  @IsOptional()
  @IsDateString()
  endAt?: string;
  ...
  @ApiProperty({ description: '颜色', example: '#4F46E5', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(20)
  color?: string;
