...
import { useRevenueByDoctor } from '@/lib/api/system/stats';
import RevenueDoctorBarChart from '../charts/RevenueDoctorBarChart';
...
export default function RevenueDoctorTab({ dateRange }: { dateRange: { startDate: string; endDate: string } }) {
