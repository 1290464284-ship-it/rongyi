...
import { createPaginatedCrudHooks, useCrudCreate, useCrudUpdate, useCrudDelete } from '@/lib/hooks/use-crud';
...
const crud = createPaginatedCrudHooks<MedicalRecord, CreateMedicalRecordDto, UpdateMedicalRecordDto, MedicalRecordQuery>('medical-records', 'medical-records');

export const useMedicalRecords = crud.useList;
export const useMedicalRecord = crud.useItem;
...
export const useCreateMedicalRecord = crud.useCreate;
export const useUpdateMedicalRecord = crud.useUpdate;
export const useDeleteMedicalRecord = crud.useDelete;
