...
const crud = createPaginatedCrudHooks<ProcessingOrder, CreateProcessingOrderDto, UpdateProcessingOrderDto, ProcessingOrdersQuery>('processing-orders', 'processing-orders');

export const useProcessingOrders = crud.useList;
export const useProcessingOrder = crud.useItem;
export const useCreateProcessingOrder = crud.useCreate;
export const useUpdateProcessingOrder = crud.useUpdate;
export const useDeleteProcessingOrder = crud.useDelete;
