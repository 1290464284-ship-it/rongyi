...
import { useCrudPaginated, useCrudCreate, useCrudUpdate, useCrudDelete } from '@/lib/hooks/use-crud';
import type { FollowUpStatus } from '@dental/shared';
...
export function useFollowUpsV2(params: {
  ...
  return useCrudPaginated<FollowUpV2, FollowUpsV2Query>('follow-ups', 'follow-ups', params);
}

export function useCreateFollowUpV2() {
  return useCrudCreate<FollowUpV2, CreateFollowUpV2Dto>('follow-ups', 'follow-ups');
}

export function useUpdateFollowUpV2() {
  return useCrudUpdate<FollowUpV2, UpdateFollowUpV2Dto>('follow-ups', 'follow-ups');
}

export function useDeleteFollowUpV2() {
  return useCrudDelete('follow-ups', 'follow-ups');
}
...
export function useCompleteFollowUpV2() {
  ...
  return useMutation({
    mutationFn: async ({ id, data }: { id: string; data: CompleteFollowUpV2Dto }) =>
      (await api.post<FollowUpV2>(`/follow-ups/${id}/complete`, data)).data,
...
export function useCreateFollowUpTemplate() {
  ...
  return useMutation({
    mutationFn: async (data: CreateFollowUpTemplateDto) =>
      (await api.post<FollowUpTemplate>('/follow-ups/templates', data)).data,
...
export function useUpdateFollowUpTemplate() {
  ...
  return useMutation({
    mutationFn: async ({ id, data }: { id: string; data: UpdateFollowUpTemplateDto }) =>
      (await api.patch<FollowUpTemplate>(`/follow-ups/templates/${id}`, data)).data,
    onSuccess: () => qc.invalidateQueries({ queryKey: ['follow-up-templates'] }),
  });
}
...
export function useDeleteFollowUpTemplate() {
  ...
  return useMutation({
    mutationFn: async (id: string) =>
      (await api.delete(`/follow-ups/templates/${id}`)).data,
    onSuccess: () => qc.invalidateQueries({ queryKey: ['follow-up-templates'] }),
  });
}
...
export function useToggleFollowUpTemplate() {
  ...
  return useMutation({
    mutationFn: async (id: string) =>
      (await api.post<FollowUpTemplate>(`/follow-ups/templates/${id}/toggle`)).data,
    onSuccess: () => qc.invalidateQueries({ queryKey: ['follow-up-templates'] }),
  });
}
...
export function useCreateFollowUpItem() {
  ...
  return useMutation({
    mutationFn: async (data: CreateFollowUpItemDto) =>
      (await api.post<FollowUpItem>('/follow-ups/items', data)).data,
...
export function useUpdateFollowUpItem() {
  ...
  return useMutation({
    mutationFn: async ({ id, data }: { id: string; data: UpdateFollowUpItemDto }) =>
      (await api.patch<FollowUpItem>(`/follow-ups/items/${id}`, data)).data,
    onSuccess: () => qc.invalidateQueries({ queryKey: ['follow-up-items'] }),
  });
}
...
export function useDeleteFollowUpItem() {
  ...
  return useMutation({
    mutationFn: async (id: string) =>
      (await api.delete(`/follow-ups/items/${id}`)).data,
    onSuccess: () => qc.invalidateQueries({ queryKey: ['follow-up-items'] }),
  });
}
...
export function useCreateFollowUpAutoRule() {
  ...
  return useMutation({
    mutationFn: async (data: CreateFollowUpAutoRuleDto) =>
      (await api.post<FollowUpAutoRule>('/follow-ups/auto-rules', data)).data,
...
export function useUpdateFollowUpAutoRule() {
  ...
  return useMutation({
    mutationFn: async ({ id, data }: { id: string; data: UpdateFollowUpAutoRuleDto }) =>
      (await api.patch<FollowUpAutoRule>(`/follow-ups/auto-rules/${id}`, data)).data,
    onSuccess: () => qc.invalidateQueries({ queryKey: ['follow-up-auto-rules'] }),
  });
}
...
export function useDeleteFollowUpAutoRule() {
  ...
  return useMutation({
    mutationFn: async (id: string) =>
      (await api.delete(`/follow-ups/auto-rules/${id}`)).data,
    onSuccess: () => qc.invalidateQueries({ queryKey: ['follow-up-auto-rules'] }),
  });
}
...
export function useToggleFollowUpAutoRule() {
  ...
  return useMutation({
    mutationFn: async (id: string) =>
      (await api.post<FollowUpAutoRule>(`/follow-ups/auto-rules/${id}/toggle`)).data,
    onSuccess: () => qc.invalidateQueries({ queryKey: ['follow-up-auto-rules'] }),
  });
}
