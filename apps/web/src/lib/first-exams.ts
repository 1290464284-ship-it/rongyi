...
export function useFirstExams(params: {
  patientId?: string;
  status?: string;
  page?: number;
  pageSize?: number;
}) {
  return useCrudPaginated<FirstExam, FirstExamQuery>('first-exams', 'first-exams', params);
}

export function useFirstExam(id: string | undefined) {
  return useCrudItem<FirstExam>('first-exams', 'first-exams', id);
}
...
export function useCreateFirstExam() {
  return useCrudCreate<FirstExam, CreateFirstExamDto>('first-exams', 'first-exams');
}

export function useUpdateFirstExam() {
  return useCrudUpdate<FirstExam, UpdateFirstExamDto>('first-exams', 'first-exams');
}

export function useDeleteFirstExam() {
  return useCrudDelete('first-exams', 'first-exams');
}
