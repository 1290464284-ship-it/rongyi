...
const resources: ResourceDefinition[] = [
  ...
  crud('registrations', 'Registration', [
    ...
    f('status', 'enum', { required: true, enumValues: ['REGISTERED', 'TRIAGED', 'STARTED', 'COMPLETED', 'CANCELLED'] }),
    f('visitId', 'relation', { relation: { resource: 'visits', foreignKey: 'visitId', labelField: 'id' } }),
  ...
  crud('visits', 'Visit', [
    ...
    f('startTime', 'datetime', { required: true }),
    f('endTime', 'datetime'),
    f('status', 'enum', { required: true, enumValues: ['REGISTERED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED'] }),
    f('nextReminder', 'date'),
  ], { roles: clinical }),
  ...
  crud('treatments', 'Treatment', [
    ...
    f('status', 'enum', { required: true, enumValues: ['PLANNED', 'APPROVED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED'] }),
    f('plannedDate', 'date'),
