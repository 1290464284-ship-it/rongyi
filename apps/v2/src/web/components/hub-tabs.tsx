...
const AppointmentBoardPage = lazy(() => import('../pages/AppointmentBoardPage').then((m) => ({ default: m.AppointmentBoardPage })));
const PatientTimelinePage = lazy(() => import('../pages/PatientTimelinePage').then((m) => ({ default: m.PatientTimelinePage })));
...
const ClinicalWorkflowPage = lazy(() => import('../pages/ClinicalWorkflowPage').then((m) => ({ default: m.ClinicalWorkflowPage })));
const HrWorkflowPage = lazy(() => import('../pages/HrWorkflowPage').then((m) => ({ default: m.HrWorkflowPage })));
...
const FinanceWorkflowPage = lazy(() => import('../pages/FinanceWorkflowPage').then((m) => ({ default: m.FinanceWorkflowPage })));
const SystemOperationsPage = lazy(() => import('../pages/SystemOperationsPage').then((m) => ({ default: m.SystemOperationsPage })));
const InventoryWorkflowPage = lazy(() => import('../pages/InventoryWorkflowPage').then((m) => ({ default: m.InventoryWorkflowPage })));
const CommunicationWorkflowPage = lazy(() => import('../pages/CommunicationWorkflowPage').then((m) => ({ default: m.CommunicationWorkflowPage })));
const FollowUpReportPage = lazy(() => import('../pages/FollowUpReportPage').then((m) => ({ default: m.FollowUpReportPage })));
const PatientWorkflowPage = lazy(() => import('../pages/PatientWorkflowPage').then((m) => ({ default: m.PatientWorkflowPage })));
const ClinicOverviewPage = lazy(() => import('../pages/ClinicOverviewPage').then((m) => ({ default: m.ClinicOverviewPage })));
...
const FirstExamsPage = lazy(() => import('../pages/FirstExamsPage').then((m) => ({ default: m.FirstExamsPage })));
const ImagingPage = lazy(() => import('../pages/ImagingPage').then((m) => ({ default: m.ImagingPage })));
const MemberCardsPage = lazy(() => import('../pages/MemberCardsPage').then((m) => ({ default: m.MemberCardsPage })));
...
const ProcessingOrdersPage = lazy(() => import('../pages/ProcessingOrdersPage').then((m) => ({ default: m.ProcessingOrdersPage })));
...
const TreatmentPlansPage = lazy(() => import('../pages/TreatmentPlansPage').then((m) => ({ default: m.TreatmentPlansPage })));
const CephalometricPage = lazy(() => import('../pages/CephalometricPage').then((m) => ({ default: m.CephalometricPage })));
...
const DispenseWorkbenchPage = lazy(() => import('../pages/DispenseWorkbenchPage').then((m) => ({ default: m.DispenseWorkbenchPage })));
