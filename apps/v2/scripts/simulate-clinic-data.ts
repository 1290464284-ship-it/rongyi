...
const VISIT_COUNT = 1500;
const CHARGE_COUNT = 4000;
const SUPPLIER_COUNT = 100;
const INVENTORY_COUNT = 300;
const MEMBER_CARD_COUNT = 600;
const PURCHASE_ORDER_COUNT = 300;
const FOLLOWUP_COUNT = 3000;
