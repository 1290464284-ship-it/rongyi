...
try {
  ...
  $login = Invoke-RestMethod -Method Post -Uri "http://127.0.0.1:3199/api/v2/auth/login" -ContentType "application/json" -Body (@{ username = "admin"; password = "admin123" } | ConvertTo-Json)
