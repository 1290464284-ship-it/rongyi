...
- Web coverage now includes follow-up, backup, simple list, and inventory
  workflow pages plus the inventory page, in addition to resource hub/page,
  hub tabs, and shared components; the expanded set passes 98% statements,
  91% branches, 98% functions, and 100% lines.
