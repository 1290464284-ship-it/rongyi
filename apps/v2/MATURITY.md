...
- Web coverage now includes follow-up, backup, simple list, and inventory
  ...
  addition to communication, HR, clinical, and patient workflow pages,
  resource hub/page, hub tabs, and shared components; the expanded set passes
  98% statements, 90% branches, 99% functions, and 100% lines.
