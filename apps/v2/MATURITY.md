...
- Coverage raised to 100% statements, 87.72% branches, 100% functions, and
  100% lines through service, HTTP, router, repository, migration, and boundary
  tests. The delivery gate is now 100/85/100/100; branch coverage is not
  artificially forced to 100 by excluding or ignoring business branches.
